...
Consider a random variable $X$ with bounded support (meaning it lives within a finite range, like $a \le \|X\| \le b$). Because it cannot shoot off to infinity, its probability distribution $P(X)$ has finite moments and can be represented by them.
